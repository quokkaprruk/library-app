...
int main() {
    ...
    if (!cin) { //this condition will always be true because cin is non-zero by default
        //using is.clear() ind Date.cpp => fail bit has been cleared => the condition evaluated to 'false' => else...(wrong)
        cin.clear();
        cin.ignore(1000, '\n');
    }
    else {
