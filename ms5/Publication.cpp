...
namespace sdds {
	...
	std::istream& Publication::read(std::istream& istr) {
		//temp variable
		char temp_title[SDDS_M_TITLE_LEN + 1] = { '\0' }; //getline is used for char[] not char*
		...
		if (conIO(istr)) {
			...
			istr.getline(temp_title, SDDS_M_TITLE_LEN + 1, '\t'); //getline is used for char[] not char*
	...
	//receive a reference of ios obj.//virtual?
